...
public class EmployeePreferencesController : ControllerBase
{
    ...
    UpdatePreference(
        int employeeId,
        UpdateEmployeePreferenceRequest request)
    {
        var employee = await _context.Employees
            .FirstOrDefaultAsync(e => e.Id == employeeId);
        ...
        preference.MaxWeeklyHours = request.MaxWeeklyHours;
    ...
    public async Task<IActionResult> DeletePreference(int employeeId)
    {
        var employee = await _context.Employees
            .FirstOrDefaultAsync(e => e.Id == employeeId);
        ...
        _context.EmployeePreferences.Remove(preference);
